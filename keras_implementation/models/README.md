...
__________________________________________________________________________________________________
encoder_embedding (Embedding)   (None, 19, 512)      6082560     encoder_inputs[0][0]             
__________________________________________________________________________________________________
bidirectional_1 (Bidirectional) (None, 19, 1024)     4198400     encoder_embedding[0][0]          
__________________________________________________________________________________________________
summarization (LSTM)            [(None, 512), (None, 3147776     bidirectional_1[0][0]            
__________________________________________________________________________________________________
dencoder_inputs (InputLayer)    (None, 10)           0                                            
__________________________________________________________________________________________________
nmt_repeat_vector (RepeatVector (None, 10, 512)      0           summarization[0][0]              
__________________________________________________________________________________________________
dencoder_embedding (Embedding)  (None, 10, 512)      3574272     dencoder_inputs[0][0]            
__________________________________________________________________________________________________
concat (Concatenate)            (None, 10, 1024)     0           nmt_repeat_vector[0][0]          
                                                                 dencoder_embedding[0][0]         
__________________________________________________________________________________________________
decoder_lstm (LSTM)             [(None, 10, 512), (N 3147776     concat[0][0]                     
                                                                 summarization[0][1]              
                                                                 summarization[0][2]              
__________________________________________________________________________________________________
dropout_1 (Dropout)             (None, 10, 512)      0           decoder_lstm[0][0]               
__________________________________________________________________________________________________
dense_1 (Dense)                 (None, 10, 6981)     3581253     dropout_1[0][0]                  
==================================================================================================
Total params: 23,732,037
Trainable params: 23,732,037
Non-trainable params: 0
